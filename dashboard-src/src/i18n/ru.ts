...
const ru: LANG_MESSAGE = {
  ...
  customCSSTip: 'Пользовательский CSS применяется глобально. Ошибочные правила могут повлиять на интерфейс панели.',
  ...
  resetSettingsConfirm:
    'Сбросить настройки панели, пользовательские метки и макеты? История соединений и настройки ядра приложения сохранятся. Это действие нельзя отменить.',
  ...
  applyConnectionFilter: 'Применять фильтр соединений',
