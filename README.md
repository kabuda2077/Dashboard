...
- `resources/EBWebView/` and `resources/icon-cache/`: runtime WebView data and proxy group icon cache generated by the app.
...
- `resources/EBWebView` and `resources/icon-cache` are runtime data directories and can be regenerated.
